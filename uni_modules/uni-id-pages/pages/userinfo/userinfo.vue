...
<template>
	<view class="uni-content">
		...
		<uni-list>
			<uni-list-item class="item" @click="setNickname('')" title="学号姓名" :rightText="userInfo.nickname||'未设置'" link>
			</uni-list-item>
      ...
      <!-- 如未开通实人认证服务，可以将实名认证入口注释 -->
		...
		<uni-popup ref="dialog" type="dialog">
			<uni-popup-dialog mode="input" :value="userInfo.nickname" @confirm="setNickname" :inputType="setNicknameIng?'nickname':'text'"
				title="设置学号姓名" placeholder="请输入要设置的学号姓名">
			</uni-popup-dialog>
		</uni-popup>
